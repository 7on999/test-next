  ...
  return (
    <div className={styles.wrapper}> 
      ...
      <div  className={styles.btnFilterWrapper}>
        <button className={filter===FiltersSeach.ALL? styles.activeFilterBtn : ''} onClick={setFilterAll}> Все задачи </button>
        <button className={filter===FiltersSeach.NOT_COMPLTETED? styles.activeFilterBtn : ''} onClick={setFilterActive} > Активные </button>
        <button className={filter===FiltersSeach.COMPLTETED? styles.activeFilterBtn : ''}onClick={setFilterCompleted} > Выполненые </button>
      </div>
    </div>
  )
}
